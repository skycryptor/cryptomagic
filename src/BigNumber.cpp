...
BigNumber::BigNumber(Context *ctx) 
    : BigNumber(nullptr, ctx) 
{
...
std::vector<char> BigNumber::toBytes() {
  std::vector<char> ret(mbedtls_mpi_size(bn_raw->get_bignum()));
